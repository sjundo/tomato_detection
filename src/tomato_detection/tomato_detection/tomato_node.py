...
class TomatoDetectionNode(Node):
    def __init__(self):
        ...
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/shj/ros2_ws/best.pt')
        ...
        # 카메라 캘리브레이션 정보 로드
        calibration_file = '/home/shj/ros2_ws/camera_calibration.xml'
    ...
    def detect_tomatoes(self):
        while True:
            ...
            cv2.imshow('detect Camera', color_image)
